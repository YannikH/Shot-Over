...
def main():
    ...
    print("""
  ######################################
  # shot_over Development Environment Setup #
  ######################################

  This script will create your shot_over dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your shot_over project folder:
    [Arma 3 installation directory]\\{} => shot_over project folder
    P:\\{}                              => shot_over project folder
