...
class shto_calculator {
    idd = 20001;
    movingEnable = true;
    onLoad = "_this call shot_over_shto_fcs_fnc_initDialog";
	onUnload = "[] call shot_over_shto_fcs_fnc_saveView; [] call shot_over_shto_fcs_fnc_openMinimized;";
	onKeyUp = "_this call shot_over_shto_fcs_fnc_dialogKeyUp;";
    class Controls {
		////////////////////////////////////////////////////////
		...
		class ButtonBase: RscButton
		{
			...
			colorShadow[] = {0,0,0,0};
			colorBorder[] = {0,0,0,0};
            onButtonClick="[] call shot_over_shto_fcs_fnc_saveView; [nil, -1] call shot_over_shto_fcs_fnc_initDialog";
		};
		...
		class RscText_1009: ButtonBase
		{
			...
			h = 0.022 * safezoneH;
            onButtonClick="[false] spawn shot_over_shto_fcs_fnc_calculateFromNotebook";
		};
...
class RscTitles {
	class shto_calculator_minimized {
		idd = 20001;
		onLoad = "[_this # 0, 0, true] call shot_over_shto_fcs_fnc_initDialog";
		//onLoad = "";
		movingEnable = 1;
		duration = 9999999;
		fadein = 0;
