...
_action = ["Open Breech","Open Breech","",{
	...
	private _breechPos = _target modelToWorld ([_target, [0,-2,0.5]] call shot_over_shto_m101_fnc_posAlongRecoilAxis);
...
}, nil, nil, {[_target, [0.11,-1.7,0.8]] call shot_over_shto_m101_fnc_posAlongRecoilAxis;}, shto_interaction_distance] call ace_interact_menu_fnc_createAction;
...
//}, nil, nil, {[_target, [0,-1.8,0.5]] call shot_over_shto_m101_fnc_posAlongRecoilAxis;}, SHTO_INTERACTION_DISTANCE] call ace_interact_menu_fnc_createAction;
//["shto_vn_static_m101_02_base", 0, [], _action] call ace_interact_menu_fnc_addActionToClass;
...
}, nil, nil, {[_target, [0.35,-1.07,0.8]] call shot_over_shto_m101_fnc_posAlongRecoilAxis;}, shto_interaction_distance] call ace_interact_menu_fnc_createAction;
["shto_vn_static_m101_02_base", 0, [], _action] call ace_interact_menu_fnc_addActionToClass;

_action = ["Fire Howitzer","Fire Howitzer","",{
	if (!isNull (gunner _target)) then {
		[_target, player] remoteExecCall ["shot_over_shto_m101_fnc_remoteFireHowitzer", gunner _target];
	} else {
		[_target, player] remoteExecCall ["shot_over_shto_m101_fnc_remoteFireHowitzer", _target];
	};
},{
	((_target animationSourcePhase "m101_reload_source") < 0.01)
}, nil, nil, {[_target, [0.2,-1,0.25]] call shot_over_shto_m101_fnc_posAlongRecoilAxis;}, shto_interaction_distance] call ace_interact_menu_fnc_createAction;
["shto_vn_static_m101_02_base", 0, [], _action] call ace_interact_menu_fnc_addActionToClass;
...
{[_target, [-0.5,-0.5,0]] call shot_over_shto_m101_fnc_posAlongDirection;}, 1, [false, false, false, true, false]] call ace_interact_menu_fnc_createAction;
["shto_vn_static_m101_02_base", 0, [], _action] call ace_interact_menu_fnc_addActionToClass;
...
{[_target, [0.4,-0.3,0.2]] call shot_over_shto_m101_fnc_posAlongDirection;}, 1, [false, false, false, true, false]] call ace_interact_menu_fnc_createAction;
["shto_vn_static_m101_02_base", 0, [], _action] call ace_interact_menu_fnc_addActionToClass;
