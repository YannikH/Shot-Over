...
private _breechPos = _howitzer modelToWorld ([_howitzer, [0,-1.5,0.5]] call shot_over_shto_m101_fnc_posAlongRecoilAxis);
...
private _magazine = [_shell] call shot_over_shto_m101_fnc_getMagazineFromShell;
