class cfgVehicles {
    ...
    class shto_vn_crate_base: vn_b_ammobox_12 {
      ...
      // class ACE_Actions: ACE_Actions {
			...
			// 			statement = "	_target remoteExec [""shot_over_shto_logistics_fnc_unpackCrate"", _target]; _target setVariable [""shto_crateIsOpen"",true];";
			// 		};
			// 	};
			// };
    ...
    class shto_vn_m101_pallet_base: Land_vn_us_common_pallet_01 {
      ...
      class EventHandlers {
        class shto_palletInit {
          init = "_this call shot_over_shto_logistics_fnc_initPallet;";
        };
      };
    };
    ...
    class shto_vn_m101_container_base: vn_us_komex_small_01 {
      ...
      class EventHandlers {
        class shto_palletInit {
          init = "_this call shot_over_shto_logistics_fnc_fillContainer;";
        };
      };
    };
